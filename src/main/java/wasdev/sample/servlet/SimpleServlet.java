...
public class SimpleServlet extends HttpServlet {
	...
	static final String JDBC_URL = "jdbc:mysql://us-cdbr-iron-east-04.cleardb.net/ad_b78a16e10bfe163?user=b156000265e20e&password=a0afca37";
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		StringBuilder msgPage = new StringBuilder();
 		...
 		try {
 			...
 			sql = "INSERT INTO " + table + " VALUES (\'David Mansur\', 31)";
